    ...
    <div className="faq-content">
      ...
      >
        <Addition type="tldr">
          <ul>
            <li>
              «Самой стабильной» версии <mark className="app">Adobe Premiere Pro</mark> не
          ...
          windowsContent={
            <>
              ...
              <p>
                ...
                <mark className="app">Adobe Premiere Pro</mark> или других творческих
                  ...
                  <Addition type="info">
                    <ul>
                      <li>
                        ...
                        <mark className="app">Adobe Premiere Pro</mark>, так и с{" "}
