    ...
    <div className="article-content">
      ...
      >
        ...
        <p>
          ...
          приложение, плагин для <mark className="app">Adobe Premiere</mark> отсутствует.
        </p>
        <ArticleMedia
          src="zbX7x8Oo_Uc"
          type="youtube"
      ...
      >
        ...
        <p>
          ...
          голос). Скачать её можно по <a href="https://www.stemroller.com/">этой</a>{" "}
          ссылке для устройств на Windows и macOS.
        </p>
        <p>
