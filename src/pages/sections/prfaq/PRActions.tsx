    ...
    <div className="faq-content">
      ...
      >
        <p>
          ...
          новее добавили поддержку автоматического перевода текста в речь. Работает как и
          на лицензионных версиях, так и на <mark className="word">народных</mark>.
        </p>
        <AdditionInfo>
          <ul>
            <li>
        ...
        <p>
          ...
          доступны при некоторых факторах. После выбора настроек - нажмите на{" "}
          <mark className="ui">Transcribe</mark> для начала транскрибации речи в текст.
        </p>
        <ImageFigure
      ...
      <DetailsSummary title="Как и чем разделить голос человека от музыки?">
        <p>
          ...
          стала доступна возможность разделить голос и{" "}
          <mark className="word">инструментал</mark> на разные дорожки с помощью
          искусственного интеллекта. Онлайн-сервисы здесь рассматривать даже не хочется,
          так как часто они предлагают такие себе условия для бесплатных пользователей:
          либо один файл в день, либо только для прослушивания без дальнейшего скачивания.
        </p>
        <p>
        ...
        <p>
          ...
          него свой аудиофайл. После обработки ваше аудио будет расположено в папку,
        ...
        />
        <AdditionWarning>
          Скорость обработки аудиофайла зависит от мощности вашего устройства, обычно оно
        ...
        <p>
          ...
          Сервис предлагает пользователям без подписки обработку одного аудиофайла в день.
        </p>
        <AdditionWarning>
          После обработки сразу сохраните обработанные аудиофайлы, чтобы их не потерять.
          Сервис не предусматривает возможность восстановления аудиофайлов после закрытия
          или смены страницы.
        </AdditionWarning>
      </DetailsSummary>
    </div>
