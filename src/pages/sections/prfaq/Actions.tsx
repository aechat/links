    ...
    <div className="faq-content">
      ...
      >
        ...
        <AdditionWarning>
          ...
          только для устройств на Windows, увы. Пользователи других операционных систем
          могут воспользоваться любыми другими сервисами и программами, которые работают с
