      ...
      <ContentFilter
        ...
        windowsContent={
          <>
            ...
            />
            <Addition type="info">
              Возможно, подобные действия нужно выполнить и для{" "}
              ...
              <ul>
                <li>
                  ...
                  <Addition type="info">
                    ...
                    <mark>SSD</mark>. Выбор медленного <mark>HDD</mark> может привести к
                    заметным «тормозам» при работе.
                  </Addition>
                </li>
                <li>
        ...
        windowsContent={
          <>
            <p>
              ...
              <mark className="app">Adobe Photoshop</mark> версии <mark>25.9</mark> или
              новее. Обычно у неё две причины: либо ваш процессор не поддерживает
            ...
            <p>
              ...
              <mark className="copy">AMD Ryzen</mark> 1000 и новее, на практике программа
              окажется менее требовательной, если ваше «железо» поддерживает инструкции{" "}
              <mark>AVX2</mark>. Однако это же значит, что она точно не запустится на{" "}
              <mark className="company">Intel</mark> 3-го поколения и ниже, а также на
              более ранних процессорах <mark className="company">AMD</mark>, где этих
              инструкций нет. Так что если ваш процессор не подходит, решение простое:
              либо установите <mark className="app">Adobe Photoshop</mark> версии{" "}
              <mark>25.7</mark> или ниже, либо, если возможно, обновите «железо».
            </p>
            ...
            <p>
              ...
              повреждёнными системными файлами <mark>Windows</mark>. Чтобы проверить их
            ...
            <p>
              ...
              данных и приложений. На <mark>Windows 11</mark> версии <mark>22H2</mark> и
              выше эта функция доступна в центре обновлений, в стандартном приложении{" "}
            ...
            <p>
              ...
              придётся заново удалять ненужные компоненты <mark>Windows</mark>, такие как{" "}
