...
const AEFromNewbies: React.FC = () => {
  return (
    <div className="faq-content">
      ...
      >
        ...
        <ul>
          ...
          <li>
            ...
            передается и обрабатывается в видеофайле. Обычно его измеряют в{" "}
            ...
            <ul>
              ...
              <li>
                <mark className="word">CQ-квантирование</mark> или{" "}
                <mark className="word">Constant Quantization</mark> - это метод сжатия
                видео, где уровень качества изображения сохраняется постоянным на
                протяжении всего видео, независимо от его сложности. Чем меньше значение,
                тем лучше качество изображения, но больше вес.
              </li>
              <li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                <mark className="video">Prores 422</mark> чаще всего используется в
                монтаже как исходники или прокси, а{" "}
          ...
          <li>
            ...
            <AdditionWarning>
              ...
              <mark>2020</mark>, <mark>2018</mark>и <mark>2022</mark>) не совместимы друг
              с другом.
            </AdditionWarning>
          </li>
          <li>
      ...
      <DetailsSummary
        title='Почему я не могу изменить скорость с помощью "усиков" в графике скорости?'
        tag="разделить оси, не редактируется плавность"
      >
        <p>
        ...
        <p>
          ...
          <mark className="ui">Bezier</mark> или на любой другой тип безье. После этого вы
      ...
      <DetailsSummary title="Применяю эффект, например Glow, но он обрезается по границе слоя. Как расширить действие эффекта?">
        <p>
          ...
          некоторые эффекты обрезаются по бокам. То есть если у вас есть композиция
          размером <mark>1920 x 1080</mark>, а слой, на который вы пытаетесь применить
          эффект - меньшего размера, то он и будет работать в его пределах. Часто это
          происходит при применении эффекта на прекомпозицию меньшего размера, чем
          основная.
        </p>
        <VideoFigure
          styleClass="figure_windows-dark"
        ...
        <p>
          ...
          стандартный эффект <mark className="plugin">Grow Bounds</mark> до всех эффектов.
          После применения нужно указать количество пикселей, на которое нужно фиктивно
          расширить слой.
        </p>
        <AdditionWarning>
          Иногда стандартный <mark className="plugin">Grow Bounds</mark> может криво
          работать или не помочь вовсе. Поэтому на помощь приходит{" "}
          <mark className="plugin">Grow Bounds</mark> от Red Giant, находящийся в пакете{" "}
          <mark className="plugin">Trapcode Suite</mark>. Инструкция по его использованию
          не нужна, он работает аналогично как и встроенный{" "}
      ...
      <DetailsSummary
        ...
        tag="тру комп дупликатор, композиция, прекомпоз, копирование"
      >
        <p>
