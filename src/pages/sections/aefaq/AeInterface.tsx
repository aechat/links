    ...
    <div className="article-content">
      ...
      >
        <p>
          ...
          новее работа с <mark className="select">«Track Matte»</mark> была переосмыслена.
          Выбор режимов <mark className="select">«Alpha»</mark> и{" "}
          <mark className="select">«Luma»</mark> вместе с инверсией заменили на компактные
          иконки, а привязка стала удобнее: теперь один слой-маску можно использовать
          сразу для нескольких слоёв.
        </p>
        <p>
