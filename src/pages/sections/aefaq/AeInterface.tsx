    ...
    <div className="article-content">
      ...
      >
        <p>
          ...
          настройка, которая предотвращает смену рабочего пространства при открытии своих
          или чужих проектов. Раньше эта особенность раздражала многих пользователей,
          поэтому <mark className="company">Adobe</mark> добавила{" "}
        ...
        <Addition type="info">
          <ul>
            ...
            <li>
              В <mark className="app">Adobe After Effects 25.X (2025)</mark> этот чекбокс
        ...
        <ul>
          ...
          <li>
            ...
            <Addition type="info">
              <p>
                <sup>1</sup> В{" "}
                <mark className="app">Adobe After Effects 25.2 (2025)</mark> и новее
                добавили функцию воспроизведения предпросмотра напрямую из дискового кэша,
                минуя оперативную память, — как в обычном видеопроигрывателе. В таком
                случае зелёная полоса будет означать промежуток, готовый к
                воспроизведению. Если дисковый кэш включён, эта опция активна по
      ...
      >
        <p>
          В <mark className="app">Adobe After Effects 25.3 (2025)</mark> и новее добавили
          функцию плавного масштабирования, а также возможность указывать нужный
          коэффициент прямо в окне предпросмотра. Он больше не ограничивается
      ...
      >
        <p>
          В <mark className="app">Adobe After Effects 23.0 (2023)</mark> и новее работа с{" "}
      ...
      >
        <p>
          ...
          <mark className="app">Adobe After Effects 23.4 (2023)</mark> и новее. Однако не
          всем пользователям понравилось это нововведение, а некоторых раздражало, что
          окно открывается автоматически при выборе определённых инструментов.
        </p>
        <p>
      ...
      >
        <Addition type="danger">
          <ul>
            ...
            <li>
              ...
              <mark className="app">Adobe After Effects 25.0 (2025)</mark> и новее эта
              инструкция больше неактуальна: при включении параметра в консоли в
        ...
        <p>
          ...
          интерфейса. В версиях <mark>14.X-24.X (2017-2024)</mark> функцию изменения цвета
          ...
          windowsContent={
            <>
              <Addition type="danger">
                <ul>
                  <li>
                    Эта инструкция ориентирована на опытных пользователей{" "}
