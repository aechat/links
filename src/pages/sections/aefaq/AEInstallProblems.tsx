    ...
    <div className="faq-content">
      ...
      >
        ...
        <p>
          ...
          новой версией программы. Перед конвертацией она покажет окно{" "}
        ...
        <p>
          ...
          достаточно запустить установщик и обновить программу как обычно. Он перезапишет
          только её основные файлы, не затрагивая ваши дополнения. После такого обновления
          вам не придётся вручную переносить плагины и пресеты со старой версии программы
          в новую.
        </p>
        <p>
          При первом запуске после обновления{" "}
          <mark className="app">Adobe After Effects</mark> появится диалоговое окно с
          предложением перенести настройки с предыдущей версии. В нём достаточно выбрать
          нужную версию, и перенос настроек начнётся автоматически.
        </p>
        <ContentFigure
          caption="Adobe After Effects"
