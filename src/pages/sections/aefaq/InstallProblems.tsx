    ...
    <div className="faq-content">
      ...
      <DetailsSummary title='Код ошибки 21 при установке After Effects или "операционная система не соответствует минимальным требованиям для этой программы установки"'>
        <p>
          ...
          новее на Windows 10 сборки <mark>21H2</mark> или старее. Если у вас стоит
          редакция <mark>LTSC</mark>, поздравляю - новее сборки, чем <mark>21H2</mark> для
          вас нет, переустанавливайте систему на редакцию Home или Pro. Или установите
          более старые сборки <mark className="app">After Effects</mark>.
        </p>
        <AdditionInfo>
