...
const AEExport: React.FC = () => {
  return (
    <div className="faq-content">
      ...
      >
        <p>
          После того как вы <a href="#4.1">подготовили исходники</a> и завершили работу
          над проектом, наступает не менее важный этап — экспорт. Правильно подобранные
          настройки помогут получить качественное изображение, оптимальный размер файла и
          обеспечить совместимость с различными платформами. В этой статье мы разберём
          ключевые параметры экспорта, которые позволят вам контролировать финальный
          результат и донести вашу работу до зрителя в наилучшем виде.
        </p>
        <Divider>Как сохранить качество и не раздуть размер файла?</Divider>
        <p>
        ...
        <p>
          ...
          прочитать в <a href="#4.1">этой статье</a>. Такие видео проще редактировать и
          ротоскопировать.
        </p>
        <ContentFigure
          ...
          type="youtube"
        />
        <Divider>Какой кодек выбрать?</Divider>
        <p>
        ...
        <ContentFigure
          ...
          type="youtube"
        />
        <Divider>CBR, VBR или CQ: как управлять битрейтом?</Divider>
        <p>
