...
const AEExport: React.FC = () => {
  return (
    <div className="faq-content">
      ...
      >
        <Addition type="tldr">
          На качество изображения и размер итогового видеофайла влияют кодек, битрейт и
          метод кодирования: <mark className="select">«CQ»</mark>,{" "}
          <mark className="select">«VBR»</mark> или <mark className="select">«CBR»</mark>,
          а также «сложность» и динамика происходящего в композиции.
        </Addition>
        <p>
        ...
        <Divider>Из чего состоит видеофайл?</Divider>
        <p>
        ...
        <Divider>Выбор кодека: для монтажа и для публикации</Divider>
        <p>
