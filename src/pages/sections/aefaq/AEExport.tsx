  ...
  return (
    <div className="faq-content">
      ...
      >
        ...
        <p>
          После того как вы <a href="#import-pipeline">подготовили исходники</a> и
          ...
          оптимальный размер файла и обеспечить совместимость с различными платформами. В
          этой статье мы разберём ключевые параметры экспорта, которые позволят вам
