    ...
    <div className="article-content">
      ...
      >
        <p>
          ...
          <mark className="app">Adobe Premiere Pro</mark>, каждый слой занимает отдельную
        ...
        <Addition type="warning">
          ...
          администратора, то импорт файлов с помощью <mark>drag&apos;n&apos;drop</mark>,
          например из <mark className="app">Проводника</mark>, работать не будет. Это не
          баг, а особенность безопасности <mark>Windows</mark>. Система просто не
          позволяет передавать файлы из приложений, запущенных с правами обычного
        ...
        <li>
          <p>
            Маска, <mark className="select">«Track Matte»</mark>
          </p>
          <NestedDetailsSummary title="Маска">
            <p>
              <mark className="select">«Mask»</mark> — область, в которой слой будет виден
              или не виден, в зависимости от типа маски и её настроек. Маска ограничена
              только этим слоем и перемещается вместе с ним. Её часто используют для
              выделения или скрытия частей изображения, а также для создания эффектов с
              плавной анимацией появления или исчезновения объектов.
            </p>
            <Addition type="info">
          ...
          <NestedDetailsSummary title="Слой направляющей">
            <p>
              <mark className="select">«Guide Layer»</mark> — атрибут, который превращает
              слой в «комментарий», видимый только в предпросмотре и не рендерящийся при
              экспорте
              <sup>1</sup>. Его можно использовать для технических оверлеев — например,
              для отображения границ перекрытий интерфейса{" "}
              <mark className="app">TikTok</mark>,{" "}
              <mark className="app">YouTube Shorts</mark>, или для передачи нужной
              информации другому пользователю проекта, чтобы тот мог внести правки позже.
            </p>
            <Addition type="info">
              <ul>
                <li>
          ...
          <NestedDetailsSummary title="Скрытые слои">
            <p>
              ...
              слою, если его нужно скрыть из таймлайна. При этом сам слой из композиции не
              исчезает и отображается, как и прежде. Такой атрибут полезен для организации
