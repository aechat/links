        ...
        <li>
          ...
          <NestedDetailsSummary title="Слой направляющей">
            <p>
              ...
              слой в своего рода «комментарий»: он виден в окне предпросмотра, но не
              рендерится при финальном экспорте<sup>1</sup>.
            </p>
            <p>
              Его можно использовать при наложении технических оверлеев, таких как границы
              интерфейса <mark className="app">TikTok</mark> или
              <mark className="app">YouTube Shorts</mark>, а также для передачи инструкций
              коллегам по проекту, чтобы им было проще внести правки позже.
            </p>
            <Addition type="info">
              <ul>
                <li>
