        ...
        <ContentFilter
          windowsContent={
            <div>
              ...
              <p>
                Если вы не хотите разбираться в причинах сбоя, самый простой выход —
                откатить систему до последнего бэкапа или точки восстановления. Но
                поскольку они есть не у всех, чаще всего приходится переустанавливать
                драйверы вручную. Перед этим не забудьте скачать нужные установочные
                файлы.
              </p>
              <ul>
                <li>
