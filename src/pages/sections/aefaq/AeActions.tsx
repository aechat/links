    ...
    <div className="article-content">
      ...
      >
        ...
        <p>
          ...
          <mark className="app">DaVinci Resolve</mark>. Однако я всё же рекомендую
          ...
          <ul>
            <li>
              ...
              <Addition type="info">
                <ul>
                  <li>
                    <mark className="word">Абсолютный путь</mark> — это полный путь от
                    корня диска, например:{" "}
      ...
      >
        ...
        <ContentFilter
          macContent={
            <>
              ...
              <p>
                Для преобразования аудио в текст можно воспользоваться утилитами, такими
                как <mark className="app">MacWhisper</mark> или{" "}
          ...
          windowsContent={
            <>
              ...
              <Addition type="info">
                ...
                воспроизведения исходников в настройках:{" "}
              ...
              <p>
                ...
                <mark className="app">FFmpeg</mark> и движка{" "}
                <mark className="app">Purfview&apos;s Faster Whisper</mark>. От скачивания
                <mark className="app">Whisper.cpp</mark> лучше отказаться из-за его
                нестабильной работы.
              </p>
              <p>
                Если нужный движок не установился автоматически, выберите его вручную: в
                окне генерации в поле <mark className="select">«Engine»</mark> укажите
        ...
        <p>
          ...
          <mark className="app">Adobe After Effects</mark>. Как уже сказано, стандартными
          средствами это сделать нельзя, поэтому воспользуемся сторонним расширением{" "}
          <a href="https://aescripts.com/subtitle-pro/">Subtitle Pro</a>. Оно позволяет
          импортировать <mark className="file">SRT</mark> как текстовый слой. Если вы
          корректно установили <mark className="plugin">Subtitle Pro</mark>, он появится в
      ...
      >
        ...
        <p>
          ...
          (по умолчанию — яркости) и хорошо подходит для простых объектов. Но если
          применить его к футажу со взрывом или сложными частицами, вы рискуете получить
          неприятную «кашу», так как этот эффект просто отсекает диапазон значений на
          основе гистограммы.
        </p>
        <ArticleMedia
          src="v7pqZ9gtn8I"
        ...
        <p>
          Если результат стандартного эффекта не устроил или вы работаете в старой версии
          программы, воспользуйтесь <mark className="plugin">uni.Unmult</mark> из пакета{" "}
          <mark className="plugin">Red Giant Universe</mark>. Он также убирает тёмные
          оттенки, делая слой прозрачным. Для удаления светлых участков достаточно
          включить параметр <mark className="select">«Invert»</mark>.
        </p>
        <Addition type="warning">
      ...
      >
        ...
        <p>
          ...
          два текстовых слоя с разной толщиной, преобразовать их в слои-фигуры и
      ...
      >
        <p>
          ...
          корректирующего слоя только на определённые слои — он влияет на все слои,
          которые расположены ниже по таймлайну. Обычно проблему решают перестановкой
