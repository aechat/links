        ...
        <AdditionWarning>
          <ul>
            <li>
              ...
              для предпросмотра без потери качества, если в композиции используются
              ...
              включенной опцией <mark className="ui">Extended Preview</mark>. Но это
              работает только при наличии в композиции векторных слоев или 3D-моделей, а
              также если в композиции есть камера, включён режим 3D для слоя или применён
              эффект, который работает в 3D-пространстве. В любом случае, на выходе вы
              получите файл с разрешением, заданным в настройках композиции.
            </li>
            <li>
