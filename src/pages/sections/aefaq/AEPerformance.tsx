    ...
    <div className="faq-content">
      ...
      >
        ...
        <p>
          ...
          зависит от множества деталей: применённых эффектов, типов слоёв, масок, режимов
          наложения и настроек управления цветом. А если у вас ещё и включена функция{" "}
          <mark className="select">«Multi-Frame Rendering»</mark>, которая обрабатывает
          несколько кадров параллельно, то расход памяти будет ещё выше.
        </p>
        <p>
