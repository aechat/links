          ...
          <li>
            ...
            <AdditionInfo>
              ...
              <li>
                ...
                <mark>
                  текущий объем оперативной памяти вашего устройства, умноженное на 2 или
                  на 3
                </mark>
                . Убедитесь в том, что вы сможете поддерживать свободное пространство на
                выбранном разделе для файла подкачки!
              </li>
            </AdditionInfo>
          </li>
          <li>
