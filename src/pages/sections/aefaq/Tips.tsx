        ...
        <ul>
          ...
          <li>
            ...
            <AdditionInfo>
              <ul>
                <li>
                  Минимальный размер файла - это изначальный размер подкачки, который
                  всегда будет использоваться в вашей системе. Максимальный размер файла -
                  это та граница, до которой <mark>Windows</mark> будет автоматически
                  расширять размер подкачки при необходимости. Если операционная система
                  достигнет этой границы, то файл выше указанного вами размера уже не
                  будет расширяться.
                </li>
                <li>
                  В качестве минимального размер файла подкачки вы можете установить от{" "}
                  <mark>2048</mark> до любого значения. Конечно, <mark>Windows</mark>{" "}
                  позволяет поставить и более низкое значение, но не всегда это
                  рекомендуется делать.
                </li>
                <li>
                  Максимальный размер файла подкачки для повседневных задач можно
                  поставить по следующей формуле -{" "}
                  <mark>
                    текущий объем оперативной памяти вашего устройства, умноженное на 2, 3
                    или 4.
                  </mark>
                  . Если вы не можете определиться с окончательным размером, то вы можете
                  установить максимальное значение <mark className="copy">65536</mark> или{" "}
