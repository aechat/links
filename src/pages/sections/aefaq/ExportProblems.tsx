    ...
    <div className="faq-content">
      ...
      >
        <p>
          ...
          <mark>23.5</mark>, где присутствует такой неприятный баг при использовании{" "}
          <mark className="app">Media Encoder</mark> в качестве программы для экспорта
          композиций.
        </p>
        <p>
      ...
      <DetailsSummary title="Почему после экспорта в видеофайл отсутствует звук в видео?">
        <p>
          ...
          то было, звук каким-то образом сбежал из контейнера!
        </p>
        <p>
          Это довольно редкий баг, связанный с кривой автоматикой вывода звука. Для
          решения проблемы и принудительного экспорта видео вместе с звуковой дорожкой вам
