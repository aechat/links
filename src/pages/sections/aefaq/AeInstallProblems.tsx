    ...
    <div className="article-content">
      ...
      >
        ...
        <p>
          ...
          достаточно запустить инсталлятор и выполнить стандартное обновление кнопкой{" "}
          <mark className="select">«Установить»</mark>. Установщик перезапишет только
          основные файлы программы, сохранив ваши дополнения, поэтому переносить плагины и
          пресеты вручную не придётся.
        </p>
        <p>
          При первом запуске после обновления программа предложит импортировать настройки
          из предыдущей версии. Для этого достаточно выбрать в списке нужную версию, и
          перенос параметров произойдёт автоматически.
        </p>
        <ArticleMedia
          ...
          windowsContent={
            <>
              <p>
                ...
                на <mark>25.2</mark>, вам придётся вручную перенести плагины, пресеты и
                прочие дополнения.
              </p>
              <Addition type="info">
