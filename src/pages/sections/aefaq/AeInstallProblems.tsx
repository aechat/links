    ...
    <div className="article-content">
                  ...
                  <Addition type="info">
                    <ul>
                      ...
                      <li>
                        ...
                        , где <mark>20XX</mark> — ваша версия программы.
                      </li>
                      <li>
      ...
      >
        ...
        <p>
          ...
          установщика: в них просто не было возможности изменить путь. В сборках это
        ...
        <Addition type="info">
          <ul>
            ...
            <li>
              ...
              . В старых версиях <mark className="app">Adobe After Effects</mark> эта
            ...
            <>
                ...
                <li>
                  ...
                  <Addition type="info">
                    <ul>
                      ...
                      <li>
                        Если какой-то плагин после переноса не отображается в новой версии{" "}
                        <mark className="app">Adobe After Effects</mark> — убедитесь в
                        том, что он поддерживает новую версию программы. В противном
                        случае найдите и установите обновлённую версию нужного вам
                        дополнения.
                      </li>
                    </ul>
                  </Addition>
              ...
              <ul>
                <li>
                  ...
                  <Addition type="info">
                    Если какой-то плагин не отображается в новой версии{" "}
                    ...
                    и установите обновлённую версию нужного вам дополнения.
                  </Addition>
                  <Addition type="warning">
                    <p>
                ...
                <li>
                  Файлы проектов и исходники, над которыми вы работали, никуда не пропадут
                  после обновления. Они будут расположены там, где вы их сохранили в
                  последний раз.
                  <Addition type="warning">
              ...
              <Addition type="danger">
                Данный способ обновления не гарантирует <mark>100%</mark> стабильной
                работы программы, поэтому все действия вы выполняете на свой страх и риск.
              </Addition>
              <p>
              ...
              <Addition type="info">
                <ul>
                  ...
                  <li>
                    Если какой-то плагин или расширение после обновления не отображается в
                    новой версии <mark className="app">Adobe After Effects</mark> —
                    убедитесь в том, что он поддерживает новую версию программы. В
                    противном случае найдите и установите обновлённую версию нужного вам
                    дополнения.
                  </li>
                </ul>
              </Addition>
