        ...
        <Addition type="warning">
          <ul>
            ...
            <li>
              ...
              <p>
                Чтобы исправить это, есть два пути: либо сразу установите программу на
                английском, либо, если она уже установлена, удалите стандартную папку с
                пресетами и переустановите софт «поверх», выбрав английский язык.
              </p>
            </li>
          </ul>
        </Addition>
