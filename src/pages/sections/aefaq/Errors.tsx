    ...
    <div className="faq-content">
      ...
      <DetailsSummary title='Ошибка 23::40, окно "Out of Memory", "After Effects has unexpectedly run out of memory and cannot complete this export" или "Low memory warning. RAM use has been extended for previews"'>
        ...
        <ul>
          ...
          <li>
            ...
            , если у вас устройство на Windows. Советую установить значение от{" "}
            <mark className="copy">4096</mark> до <mark className="copy">65536</mark> или{" "}
            <mark className="copy">131072</mark>. В таком случае система будет создавать
            файл подкачки с изначальным размером в <mark>4 Гб</mark>, который динамически
            может расширяться до <mark>64 Гб</mark> или <mark>128 Гб</mark>, в большинстве
            случаев этого хватит.
            <AdditionWarning>
          ...
          <li>
            ...
            периодической очистки оперативной памяти, если у вас Windows, и настройте
            очистку оперативной памяти при достижении <mark>90%</mark> заполненной памяти.
            <AdditionInfo>
        ...
        <p>
          Обычно эти советы могут помочь избавиться от типичных проблем с нехваткой
          оперативной памяти и затупами программы, но полностью исключить не могут, увы.
        </p>
      </DetailsSummary>
      ...
      <DetailsSummary title="Unable to allocate enough memory to render the current frame (XXXX x XXXX @ X bpc). Either decrease the memory requirements for the rendering frame, or install more RAM">
        ...
        <p>
          ...
          (будет создаваться файл подкачки с изначальным размером в <mark>4 Гб</mark>,
          который динамически может расширяться до <mark>64 Гб</mark>), в большинстве
      ...
      <DetailsSummary title='"File is damaged", "Unable to import file (НАЗВАНИЕ_ФАЙЛА.XYZ) as project (bad format or not readable)" или "Error with file"'>
        ...
        <p>
          ...
          на разделах, вы могли упустить такую мелочь и можете столкнуться с
