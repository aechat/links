            ...
            <div className="rules-content">
              <section className="rules-section faq-content">
                ...
                <ul>
                  ...
                  <li>
                    Если у вас возникла ошибка или проблема с программой или дополнением —
                    покажите её и расскажите, что именно вы делали перед тем, как что-то
                    пошло не так. Чем подробнее будет описание, тем быстрее получится
                    понять и устранить неполадку, исключив лишние догадки.
                  </li>
                  <li>
                  ...
                  <li>
                    Показывая проблему, пожалуйста, не делайте снимки экрана или видео
                    вашего устройства с помощью камеры телефона. На них ничего толком не
                    видно и захватывается не вся нужная область. Также, публикуя скриншот,
                    фото или видео, стоит написать сам вопрос в одном сообщении с ними, а
                    не в следующем. Не стоит публиковать и перевод окна ошибки через
                    условный <mark className="app">Google Lens</mark> — это, наоборот,
                    замедляет поиск решения из-за неточного перевода.
                    <Addition type="warning">
                      Администрация первое время может закрыть глаза на фото экрана,
                      сделанное с телефона, но если это повторится — сообщение могут
                      удалить, а отправителя перевести в режим чтения, чтобы он всё-таки
                    ...
                    <ContentFilter
                      macContent={
                        <div>
                          <p>
                            ...
                            <mark>macOS</mark> делают скриншоты ещё неохотнее, чем те, кто
                            сидит на <mark>Windows</mark>. Для решения этой проблемы{" "}
                            <mark className="company">Apple</mark> оставила вам полезные
                          ...
                          <ul style={{marginInline: "-15px"}}>
                            <li>
                              ...
                              эта комбинация клавиш позволяет сделать скриншот всего
                              экрана. Изображение автоматически сохранится в буфере
                              обмена, откуда его можно вставить в{" "}
                            ...
                            <li>
                              ...
                              <Addition type="warning">
                                ...
                                открывается корректно. Чтобы ваш полученный скринкаст
                                открылся у каждого — перекодируйте видео в{" "}
                      ...
                      windowsContent={
                        <div>
                          <p>
                            Чтобы сделать скриншот, воспользуйтесь клавишей{" "}
                            ...
                            скринкаст вашего экрана без необходимости доставать мобильное
                            устройство.
                          </p>
                          <Addition type="info">
                          ...
                          <p>
                            ...
                            сторонних утилит для съёмки экрана или создания скриншотов.
                          </p>
                          <div
