        ...
        <div>
          ...
          {isFaqPage(path) && (
            <>
              ...
              <p className={styles["footer-content-info"]}>
                Администрация страницы не несёт ответственности за возможные последствия
                использования опубликованной информации, программ, файлов или сторонних
                ресурсов, упомянутых в статьях.
              </p>
              {renderCommitInfo()}
            </>
          )}
